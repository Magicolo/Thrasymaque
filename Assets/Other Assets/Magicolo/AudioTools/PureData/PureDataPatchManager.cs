...
namespace Magicolo.AudioTools {
	...
	public class PureDataPatchManager {
		...
		public string GetPatchPath(string patchName) {
			string path = Application.streamingAssetsPath + Path.DirectorySeparatorChar + pureData.generalSettings.patchesPath + Path.DirectorySeparatorChar + patchName + ".pd";
		...
		public void Start() {
			Open("Internal" + Path.DirectorySeparatorChar + "uresources");
		}
