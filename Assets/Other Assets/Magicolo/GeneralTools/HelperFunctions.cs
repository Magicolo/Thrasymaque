...
namespace Magicolo {
	public static class HelperFunctions {
		...
		public static T LoadAssetInFolder<T>(string assetFileName, string folderName) where T : Object {
			...
			#if UNITY_EDITOR
			asset = UnityEditor.AssetDatabase.LoadAssetAtPath(GetFolderPath(folderName) + Path.DirectorySeparatorChar + assetFileName, typeof(T)) as T;
			#endif
		...
		public static Object[] LoadAssetsInFolder<T>(string assetFileName, string folderName) where T : Object {
			...
			#if UNITY_EDITOR
			assets = UnityEditor.AssetDatabase.LoadAllAssetsAtPath(GetFolderPath(folderName) + Path.DirectorySeparatorChar + assetFileName);
			#endif
